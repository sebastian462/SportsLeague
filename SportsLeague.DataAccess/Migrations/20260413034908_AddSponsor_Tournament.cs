...
{
    /// <inheritdoc />
    public partial class AddSponsor_Tournament : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_TornamentTeams_Teams_TeamId",
                table: "TornamentTeams");

            migrationBuilder.DropForeignKey(
                name: "FK_TornamentTeams_Tournaments_TournamentId",
                table: "TornamentTeams");

            migrationBuilder.DropPrimaryKey(
                name: "PK_TornamentTeams",
                table: "TornamentTeams");
            ...
            migrationBuilder.RenameIndex(
                name: "IX_TornamentTeams_TournamentId_TeamId",
                table: "TournamentTeams",
                newName: "IX_TournamentTeams_TournamentId_TeamId");

            migrationBuilder.RenameIndex(
                name: "IX_TornamentTeams_TeamId",
                table: "TournamentTeams",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameTable(
                ...
                newName: "TornamentTeams");

            migrationBuilder.RenameIndex(
                name: "IX_TournamentTeams_TournamentId_TeamId",
                table: "TornamentTeams",
                newName: "IX_TornamentTeams_TournamentId_TeamId");

            migrationBuilder.RenameIndex(
                name: "IX_TournamentTeams_TeamId",
                table: "TornamentTeams",
                newName: "IX_TornamentTeams_TeamId");
